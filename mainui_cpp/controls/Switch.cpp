...
{
	iSelectColor.SetDefault( uiColorWhite );
	iBackgroundColor.SetDefault(uiColorWhite);
	iFgTextColor.SetDefault(uiColorWhite);
	iBgTextColor.SetDefault(uiColorWhite);
