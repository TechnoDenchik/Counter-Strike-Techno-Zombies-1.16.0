...
void CMenuSpinControl::Draw( void )
{
	...
	if( iFlags & QMF_GRAYED )
	{
		...
		UI_DrawString( font, scCenterPos, scCenterBox, m_szDisplay, uiColorWhite, m_scChSize, eTextAlignment, textflags | ETF_FORCECOL );
		UI::Scissor::PopScissor();
		UI_DrawPic( left, arrow, uiColorWhite, m_szLeftArrow );
		UI_DrawPic( right, arrow, uiColorWhite, m_szRightArrow );
		return; // grayed
	}
