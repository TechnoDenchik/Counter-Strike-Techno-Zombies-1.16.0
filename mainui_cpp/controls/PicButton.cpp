...
void CMenuPicButton::Draw( )
{
	...
	if( hPic )
	{
		...
		UnpackRGB( r, g, b, iFlags & QMF_GRAYED ? uiColorWhite : uiColorWhite );
...
#endif
			UI_DrawString( font, m_scPos, m_scSize, szName, uiColorWhite, m_scChSize, eTextAlignment, textflags );
			return; // grayed
		}
