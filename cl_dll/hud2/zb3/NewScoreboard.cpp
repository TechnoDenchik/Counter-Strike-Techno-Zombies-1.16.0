...
int CHudZB3ScoreBoard::Draw(float time)
{
	...
	gEngfuncs.pTriAPI->Color4ub(255, 255, 255, 255);
	DrawTexturedNumbersTopRightAligned(*countplayer, m_rcToprecord, roundmax, x16 + 19, y16 + 14, 1.0f);
	gEngfuncs.pTriAPI->Color4ub(255, 255, 255, 255);
	DrawTexturedNumbersTopRightAligned(*countplayer, m_rcToprecord, roundNumber2, x16 - 24, y16 + 14, 1.0f);

	gEngfuncs.pTriAPI->Color4ub(255, 255, 255, 255);
	DrawTexturedNumbersTopRightAligned(*winhm, m_rcTeamnumber, scoreCT, x4 + 70, y4 + 14, 1.0f);
	DrawTexturedNumbersTopRightAligned(*winzb, m_rcSelfnumber, scoreT, x3 - 87, y3 + 14, 1.0f);
	DrawTexturedNumbersTopRightAligned(*countplayer, m_rcToprecord, countHM, x5 + 77, y5, 1.0f);
	DrawTexturedNumbersTopRightAligned(*countplayer, m_rcToprecord, countZB, x6 - 87, y5, 1.0f);
