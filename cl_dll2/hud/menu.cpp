...
void CHudMenu::ShowVGUIMenu( int menuType )
{
	...
	case MENU_BUY_PISTOL:
		...
		case MOD_ZB3:
			...
			szCmd = "exec touch/zb3/buy_pistol_t.cfg";
			else szCmd = "exec touch/zb3/buy_pistol_ct.cfg";
			break;
	...
	case MENU_BUY_SHOTGUN:
		...
		case MOD_ZB3:
			if (g_PlayerExtraInfo[gHUD.m_Scoreboard.m_iPlayerNum].teamnumber == TEAM_TERRORIST)
				szCmd = "exec touch/zb3/buy_shotgun_t.cfg";
			else szCmd = "exec touch/zb3/buy_shotgun_ct.cfg";
			break;
	...
	case MENU_BUY_RIFLE:
		...
		case MOD_ZB3:
			if (g_PlayerExtraInfo[gHUD.m_Scoreboard.m_iPlayerNum].teamnumber == TEAM_TERRORIST)
				szCmd = "exec touch/zb3/buy_rifle_t.cfg";
			else szCmd = "exec touch/zb3/buy_rifle_ct.cfg";
			break;
	...
	case MENU_BUY_SUBMACHINEGUN:
		...
		case MOD_ZB3:
			if (g_PlayerExtraInfo[gHUD.m_Scoreboard.m_iPlayerNum].teamnumber == TEAM_TERRORIST)
				szCmd = "exec touch/zb3/buy_submachinegun_t.cfg";
			else szCmd = "exec touch/zb3/buy_submachinegun_ct.cfg";
			break;
	...
	case MENU_BUY_MACHINEGUN:
		...
		case MOD_ZB3:
			if (g_PlayerExtraInfo[gHUD.m_Scoreboard.m_iPlayerNum].teamnumber == TEAM_TERRORIST)
				szCmd = "exec touch/zb3/buy_machinegun_t.cfg";
			else szCmd = "exec touch/zb3/buy_machinegun_ct.cfg";
			break;
	...
	case MENU_BUY_ITEM:
		...
		case MOD_ZB3:
			if (g_PlayerExtraInfo[gHUD.m_Scoreboard.m_iPlayerNum].teamnumber == TEAM_TERRORIST)
				szCmd = "exec touch/zb3/buy_item_t.cfg";
			else szCmd = "exec touch/zb3/buy_item_ct.cfg";
			break;
